...
function isEven(number) {
  ...
  function calculateArithmeticMean(list) {
    const sumList = list.reduce( //que esta haciendo ese reduce a la lista 
  ...
  const worldSalaries = world.map(
    function (person) { //le paso un parametro personas
      return person.salary; //Como entiende el computador para que entre al salario de las personas.
